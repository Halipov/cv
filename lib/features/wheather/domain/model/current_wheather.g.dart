...
part of 'current_wheather.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CurrentWheather _$CurrentWheatherFromJson(Map<String, dynamic> json) =>
    CurrentWheather(
...
Map<String, dynamic> _$CurrentWheatherToJson(CurrentWheather instance) =>
    <String, dynamic>{
